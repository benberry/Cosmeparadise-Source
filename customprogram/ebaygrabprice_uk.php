...
$cookieFile = '/tmp/ebaycookie_uk.txt';
...
if (($handle = fopen($csvfile, "r")) !== FALSE) {	//OPEN CSV
	...
	if($row>1){
			...
			{	//echo "have record<br>";
				...
				{	
					//echo "have Shop<br>";
					$first_Shop_pos = strpos( $string , "Shop:");
					//echo "first_Shop_pos:".$first_Shop_pos."<br>";
					while($counting < 10)
					{	$startpos = strpos($string, 'itemprop="name">', $stoppos);	
						$stoppos = strpos($string, '</table>', $startpos);						
						if($first_Shop_pos > $startpos && $first_Shop_pos < $stoppos)
						{	
...
/////////////open file and write into it///////////////
	$filename = "./ebaygrabprice_uk.csv";
	$ourFileHandle = fopen($filename, 'w') or die("can't open file");
	fputs($ourFileHandle, $line);
	//close file after write the content into it
	fclose($ourFileHandle);
	
	echo "<br><br>success. check file link <a href=\"./ebaygrabprice_uk.csv\">Here</a><br>";
