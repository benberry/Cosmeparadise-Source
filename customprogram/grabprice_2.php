...
<html>
<body>
<h2>EB-OZ-BS-SBN-HC-TB-YES-CD grab product price programme 2</h2>
<b>Please keep the format: sku, name, SBN URL, ebeauty URL, ozcosmetics URL, brandshopping URL, HotCOSMETICS URL, Cosmetics Now URL, TopBuy Price, YESSTYLE, Cosme-de(SKIP first row of header)</b>
<form action="grabprice_2.php" method="post" enctype="multipart/form-data">
...
else "can't open file <br>";
fclose($handle);



/////////////open file and write into it///////////////
	$filename = "./grabprice_2.csv";
	$ourFileHandle = fopen($filename, 'w') or die("can't open file");
	fputs($ourFileHandle, $line);
	//close file after write the content into it
	fclose($ourFileHandle);
	
	echo "<br><br>success. check file link <a href=\"./grabprice_2.csv\">Here</a><br>";
