...
<html>
<body>
<h2>EB-OZ-BS-SBN-HC-TB-YES-CD grab product price programme</h2>
...
<form action="grabprice.php" method="post" enctype="multipart/form-data">
...
/////////////open file and write into it///////////////
	$filename = "./grabprice.csv";
	$ourFileHandle = fopen($filename, 'w') or die("can't open file");
	fputs($ourFileHandle, $line);
	//close file after write the content into it
	fclose($ourFileHandle);
	
	echo "<br><br>success. check file link <a href=\"./grabprice.csv\">Here</a><br>";
