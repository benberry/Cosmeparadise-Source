...
<tr><td colspan="5"><p align="center"><a href="http://www.cosmeparadise.com/"><span style="text-decoration:none;text-underline:none"><img border="0" src="https://a792ded0d2-custmedia.vresp.com/library/1364200909/6c81b2ad0a/logo.gif" alt="Cosme Paradise"></span></a></p></td></tr>
<tr><td align="center" colspan="5">       
<p><img usemap="#navigationbar" border="0" width="545px" height="25" src="https://a792ded0d2-custmedia.vresp.com/library/1364200750/9be25e48b0/EDM-Bar-2.gif" alt="top menu"></p>
...
if(isset($_POST["banner1"]) && $_POST["banner1"] != "")
	$product_html .=  '<tr><td align="center" colspan="5"><a target="_blank" href="'.$_POST["banner1D"].'"><img style="display:block;border:0;" src="'.$_POST["banner1"].'" alt="top image" /></a></td></tr>';
		

 $product_html .= '<tr>
 <td width="220" style="padding:8px;"><b><a target="_blank" href="'.$_POST["FULLLIST_LINK"].'">'.$_POST["FULLLIST_TEXT"].'</a></b></td>
 <td width="80" ><b>R.R.P.</b></td>
 <td width="60" align="center"><b>SAVE</b></td>
 ...
 foreach($skulist as $sku)
{
	...
	//{	$product_html .= '<td align="center"><div style="font-family:arial;"><span style="color:#F660AB;font-weight:bold;font-size:24px;text-decoration: line-through;">A$'.number_format($_product->getPrice(),2,'.','').'</span><br />';
	//	$product_html .= '<span style="font-size:14px;font-weight:bold;color:#FF0000;">SAVE<br />'.(round(($_product->getMsrp()-$_price)/$_product->getMsrp(),2)*100).'%</span><td>';
	//	//$product_html .= '<span style="font-size:20px;font-weight:bold;color:#FF0000;">A$'.number_format($_price,2,'.','').'</span></div></td>';
	//}	
	//else
	//{	
	$product_html .= '<td align="center"><div style="font-family:arial;"><span style="font-size:14px;font-weight:bold;color:#FF0000;">SAVE<br />'.(round(($_product->getMsrp()-$_price)/$_product->getMsrp(),2)*100).'%</span></div></td>';
		//$product_html .= '<span style="color:#F660AB;font-weight:bold;font-size:24px">A$'.number_format($_price,2,'.','').'</span></div></td>';
	//}
	...
	//$product_html .=  '</td>';
	$product_html .=  '<td align="right" style="padding-right:10px;"><b><a href="'.$_product->getProductUrl().'" target="_blank">Buy Now</a></b></td>';
	
	/*if( $counting % 3 == 0 && $counting+3 != $skucount)
		$product_html .=  '</tr><tr><td colspan="5"><hr /></td></tr><tr>';
...
$product_html .=  '<tr><td align="center" colspan="5"><img style="border:0;" src="https://a792ded0d2-custmedia.vresp.com/library/1380092964/6a5a8541bc/promo-bar.gif" alt="promotion bar" /></td></tr>';
/////////////////////////////////Here for Promotion Banner/////////////////////////	
if(isset($_POST["banner2"]) && $_POST["banner2"] != "")
	$product_html .=  '<tr><td align="center" colspan="5"><a target="_blank" href="'.$_POST["banner2D"].'"><img style="display:block;border:0;" src="'.$_POST["banner2"].'" alt="promotion oimage" /></a></td></tr>';
if(isset($_POST["banner3"]) && $_POST["banner3"] != "")
	$product_html .=  '<tr><td align="center" colspan="5"><a target="_blank" href="'.$_POST["banner3D"].'"><img style="display:block;border:0;" src="'.$_POST["banner3"].'" alt="promotion oimage" /></a></td></tr>';
if(isset($_POST["banner4"]) && $_POST["banner4"] != "")
	$product_html .=  '<tr><td align="center" colspan="5"><a target="_blank" href="'.$_POST["banner4D"].'"><img style="display:block;border:0;" src="'.$_POST["banner4"].'" alt="promotion oimage" /></a></td></tr>';
if(isset($_POST["banner5"]) && $_POST["banner5"] != "")
	$product_html .=  '<tr><td align="center" colspan="5"><a target="_blank" href="'.$_POST["banner5D"].'"><img style="display:block;border:0;" src="'.$_POST["banner5"].'" alt="promotion oimage" /></a></td></tr>';
if(isset($_POST["banner6"]) && $_POST["banner6"] != "")
	$product_html .=  '<tr><td align="center" colspan="5"><a target="_blank" href="'.$_POST["banner6D"].'"><img style="display:block;border:0;" src="'.$_POST["banner6"].'" alt="promotion oimage" /></a></td></tr>';
if(isset($_POST["banner7"]) && $_POST["banner7"] != "")
	$product_html .=  '<tr><td align="center" colspan="5"><a target="_blank" href="'.$_POST["banner7D"].'"><img style="display:block;border:0;" src="'.$_POST["banner7"].'" alt="promotion oimage" /></a></td></tr>';
if(isset($_POST["banner8"]) && $_POST["banner8"] != "")
	$product_html .=  '<tr><td align="center" colspan="5"><a target="_blank" href="'.$_POST["banner8D"].'"><img style="display:block;border:0;" src="'.$_POST["banner8"].'" alt="promotion oimage" /></a></td></tr>';
if(isset($_POST["banner9"]) && $_POST["banner9"] != "")
	$product_html .=  '<tr><td align="center" colspan="5"><a target="_blank" href="'.$_POST["banner9D"].'"><img style="display:block;border:0;" src="'.$_POST["banner9"].'" alt="promotion oimage" /></a></td></tr>';
if(isset($_POST["banner10"]) && $_POST["banner10"] != "")
	$product_html .=  '<tr><td align="center" colspan="5"><a target="_blank" href="'.$_POST["banner10D"].'"><img style="display:block;border:0;" src="'.$_POST["banner10"].'" alt="promotion oimage" /></a></td></tr>';
if(isset($_POST["banner11"]) && $_POST["banner11"] != "")
	$product_html .=  '<tr><td align="center" colspan="5"><a target="_blank" href="'.$_POST["banner11D"].'"><img style="display:block;border:0;" src="'.$_POST["banner11"].'" alt="promotion oimage" /></a></td></tr>';
/////////////Social Media/////////////
...
$product_html .=  '<tr><td align="center" colspan="5"><img style="border:0;" src="https://a792ded0d2-custmedia.vresp.com/library/1380093483/2b362e0393/EDM-Bar-freeship.gif" alt="free shipping" /></td></tr>';	
$product_html .=  '</table>';
