...
<?php	
		...
		$requestXmlBody .= '<SKU>9679</SKU>';
		$requestXmlBody .= '<VariationSKU>9679</VariationSKU>';
		//$requestXmlBody .= '<ItemID>181307160245</ItemID>';
		...
		echo str_replace('<?xml version="1.0" encoding="UTF-8"?>', '', $responseXml);
	/*	
		...
		if($errors->length > 0)
		{
            ...
            echo $responseDoc;
			//get results nodes
            $responses = $responseDoc->getElementsByTagName("GetItemResponse");
