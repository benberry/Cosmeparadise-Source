...
<form action="GetSellerListTest.php" method="post" enctype="multipart/form-data">
...
require_once('../get-common/eBaySession.php');
		...
		if($errors->length > 0)
		{
            ...
            foreach ($responses as $response) {
              ...
              foreach($Items as $Item) {                
				...
				if($counting%2 == 0)
					...
					$classname = "cwhite";
                echo '<tr class="'.$classname.'" id="ref'.$counting.'"><form action="../ReviseItem/ReviseItemTest.php" method="post" enctype="multipart/form-data">';
			...
			//////////////for bulk OS/////////////////
			if($BulkUpdateItems != "")
			{	echo '<tr><td><form action="../ReviseItem/ReviseItemTest.php" method="post" enctype="multipart/form-data">';
			...
			//////////////for bulk QTY update/////////////////
			if($BulkUpdateItems != "")
			{	echo '<tr><td><form id="BQTYFORM" action="../ReviseItem/ReviseItemTest.php" method="post" enctype="multipart/form-data">';
				echo '<input type="hidden" name="customlabel" value="'.$CustomLabel.'" />'.$BulkUpdateItems;
