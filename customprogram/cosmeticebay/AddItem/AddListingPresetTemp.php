...
if(isset($_SESSION['product_id']))
{
	...
	echo 'Missing SKU, back to Select <a href="http://www.cosmeparadise.com/customprogram/cameraebay/ebaycontrol.php" target="_self">Page</>';
	exit;
}		*/
...
<?php
	...
	{	$new_sku = "";
		...
		echo '</tr></table>';
		echo 'Total cost(HKD): <input type="text" value="'.$combination_cost.'" id="TotalCost" name="TotalCost" />';
	}*/
	...
	{	echo "Combination Exist!";
		...
		echo '<br>New Combination &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="http://www.cosmeparadise.com/customprogram/cameraebay/ebaycontrol.php">Back To Combo Select</a><br><br>';*/
?>
...
<td>SKU<star class="Mandatory">*</star></td><td><input type="text" name="SKU" value="<?php echo $new_sku ?>" class="disabled" readonly /></td>
...
<td>ListingDuration</td><td><select class="selectinput" name="ListingDuration"><option value="GTC">GTC</option><option value="Days_1">1 Day</option><option value="Days_3">3 Days</option><option value="Days_5">5 Days</option><option value="Days_7">7 Days</option><option value="Days_10">10 Days</option><option value="Days_14">14 Days</option><option value="Days_21">21 Days</option><option value="Days_30">30 Days</option></select></td>
...
<?php
     ...
     /*ini_set('magic_quotes_gpc', false);    // magic quotes will only confuse things like escaping apostrophe
		...
		$compatabilityLevel = 697;
			...
			$requestXmlBody .= '<ApplicationURL>http://www.cosmeparadise.com/customprogram/cameraebay/Notif-ItemRevised/Notif-ItemRevised.php</ApplicationURL>';
