<?php
require_once '../xajax-0.6-beta1/xajax_core/xajax.inc.php';  //THIS MUST BE DOWNLOADED FROM http://xajax.sourceforge.net/

// ENTER YOUR OWN DATABASE CONNECTION INFORMATION OR CHANGE THIS TO AN INCLUDE FOR YOUR INFORMATION
mysql_connect("localhost","cosmepar_program","RecapsBoronWhirlGrands45");
mysql_select_db("cosmepar_custom");
