...
echo "start<br>";
$csvfile = "/home/cosmepar/cosmeparadise.com/html/customprogram/grabprice/price2.csv";
////////////////////timer//////////////
...
/////////////open file and write into it///////////////
	$filename = "./grabprice/grabprice_p2.csv";
   ...
   function sendEmail($totaltime)
	 {		
		...
		$mail->AddAttachment('/home/cosmepar/cosmeparadise.com/html/customprogram/grabprice/grabprice_p2.csv');         // Add attachments
		//$mail->AddAttachment('/tmp/image.jpg', 'new.jpg');    // Optional name
		$mail->IsHTML(true);                                  // Set email format to HTML
		
		$mail->Subject = 'Grab Price part 2 finished';
		$mail->Body    = "It take ".$totaltime." sec to finish.<br><br>success. check file link <a href=\"http://www.cosmeparadise.com/customprogram/grabprice/grabprice_p2.csv\">Here</a><br> Or download from attachment.";
