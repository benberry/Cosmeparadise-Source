...
/*$sql = "SELECT DISTINCT(product_line.value) AS option_id
FROM catalog_product_entity_int current_p_type
INNER JOIN catalog_product_entity_int product_line ON product_line.entity_id = current_p_type.entity_id AND product_line.attribute_id =154 AND product_line.store_id =0
WHERE current_p_type.attribute_id = 150 AND current_p_type.value = 1233 AND current_p_type.store_id =0";*/
$count_line = 0;
...
/////////////////get execution time//////////////
    ...
    echo "This program run though ".$totaltime." seconds <br>"; 
   
	echo "finish! Total line:".$count_line."<br>";
